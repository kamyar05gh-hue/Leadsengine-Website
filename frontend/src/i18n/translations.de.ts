...
export const de = {
  ...
  legal: {
    ...
    /* FUTURE MEDIA'S OWN AGB, at the client's instruction — these are the
       terms published at future-media.ch/agb, reproduced here for Leads
       Engine, which is a Future Media product.

       ONE CHARACTER IS NOT VERBATIM: section 9 reads "der SFuture Media
       GmbH" on the source page. That is a typo, not a term, and it is
       corrected to "der Future Media GmbH" here. Nothing else is altered.

       Section 9 also refers to a Datenschutzerklärung that is linked on the
       source page; the link is not reproducible as plain body text, and this
       site's own Datenschutz page is one click away in the footer. */
    terms: {
